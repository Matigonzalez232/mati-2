            ...
            <div class="container custom-container">
                <div class="header-menu-content">
                    <nav class="navbar navbar-expand-xl p-0">
                        <a class="site-logo site-title" href="index.html"><img src="<?= URL ?>/assets/theme/assets/images/logo.png" alt="site-logo"></a>
                                    ...
                                    <ul class="header-links">
                                        <li>
                                            <a href="mailto:">
                                                <div class="links-thumb">
                                                    <img src="<?= URL ?>/assets/theme/assets/images/icon/icon-1.png" alt="icon">
                                                </div>
                                        ...
                                        <li>
                                            <a href="tel:+11256326501">
                                                <div class="links-thumb">
                                                    <img src="<?= URL ?>/assets/theme/assets/images/icon/icon-2.png" alt="icon">
                                                </div>
