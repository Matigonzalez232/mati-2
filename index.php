...
<section class="banner-section">
    ...
    <div class="banner-element-one">
        <img src="<?= URL ?>/<?= URL?>/assets/theme//theme/assets/images/element/element-3.png" alt="element">
    </div>
    <div class="banner-element-two">
        <img src="<?= URL ?>/assets/theme/assets/images/element/element-4.png" alt="element">
    </div>
    ...
    <div class="banner-group-shape">
        <div class="banner-group-element-one">
            <img src="<?= URL ?>/assets/theme/assets/images/element/element-8.png" alt="element">
        </div>
        <div class="banner-group-element-two">
            <img src="<?= URL ?>/assets/theme/assets/images/element/element-9.png" alt="element">
        </div>
        <div class="banner-group-element-three">
            <img src="<?= URL ?>/assets/theme/assets/images/element/element-10.png" alt="element">
        </div>
        ...
        <div class="banner-group-element-six">
            <img src="<?= URL ?>/assets/theme/assets/images/element/element-11.png" alt="element">
        </div>
        <div class="banner-group-element-seven">
            <img src="<?= URL ?>/assets/theme/assets/images/element/element-12.png" alt="element">
        </div>
        <div class="banner-group-element-eight">
            <img src="<?= URL ?>/assets/theme/assets/images/element/element-13.png" alt="element">
        </div>
        <div class="banner-group-element-nine">
            <img src="<?= URL ?>/assets/theme/assets/images/element/element-14.png" alt="element">
        </div>
        <div class="banner-group-element-ten">
            <img src="<?= URL ?>/assets/theme/assets/images/element/element-15.png" alt="element">
        </div>
        ...
        <div class="banner-group-element-twelve">
            <img src="<?= URL ?>/assets/theme/assets/images/element/element-17.png" alt="element">
        </div>
        <div class="banner-group-element-thirteen">
            <img src="<?= URL ?>/assets/theme/assets/images/element/element-18.png" alt="element">
        </div>
        <div class="banner-group-element-fourteen">
            <img src="<?= URL ?>/assets/theme/assets/images/element/element-19.png" alt="element">
        </div>
        <div class="banner-group-element-fifteen">
            <img src="<?= URL ?>/assets/theme/assets/images/element/element-20.png" alt="element">
        </div>
        <div class="banner-group-element-sixteen">
            <img src="<?= URL ?>/assets/theme/assets/images/element/element-21.png" alt="element">
        </div>
        <div class="banner-group-element-seventeen">
            <img src="<?= URL ?>/assets/theme/assets/images/element/element-22.png" alt="element">
        </div>
    </div>
                        ...
                        <div class="banner-widget-wrapper">
                            <div class="banner-widget-left">
                                <div class="banner-widget-thumb">
                                    <img src="<?= URL ?>/assets/theme/assets/images/element/element-2.png" alt="element">
                                </div>
                            </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <img src="<?= URL ?>/assets/theme/assets/images/brand/brand-1.png" alt="brand">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <img src="<?= URL ?>/assets/theme/assets/images/brand/brand-2.png" alt="brand">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <img src="<?= URL ?>/assets/theme/assets/images/brand/brand-3.png" alt="brand">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <img src="<?= URL ?>/assets/theme/assets/images/brand/brand-4.png" alt="brand">
                                </div>
                            </div>
                        </div>
                    </div>
...
<section class="project-section pb-120">
    ...
    <div class="project-element-three">
        <img src="<?= URL ?>/assets/theme/assets/images/element/element-25.png" alt="element">
    </div>
        ...
        <div class="project-item-wrapper">
            <div class="row justify-content-center mb-30-none">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-30">
                    <div class="project-item">
                        <div class="project-thumb">
                            <img src="<?= URL ?>/assets/theme/assets/images/project/project-1.png" alt="project">
                        </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-30">
                    <div class="project-item">
                        <div class="project-thumb">
                            <img src="<?= URL ?>/assets/theme/assets/images/project/project-2.png" alt="project">
                        </div>
                        <div class="project-overlay">
                            <div class="overlay-content">
                                <h4 class="title"><a href="project-details.html">Brand redesign meanwhile <br> focusing product</a></h4>
...
<section class="choose-section pb-120">
    <div class="choose-element-one" data-aos="fade-left" data-aos-duration="1200">
        <img src="<?= URL ?>/assets/theme/assets/images/element/element-28.png" alt="element">
    </div>
    <div class="choose-element-two">
        <img src="<?= URL ?>/assets/theme/assets/images/element/element-29.png" alt="element">
    </div>
    <div class="choose-element-three">
        <img src="<?= URL ?>/assets/theme/assets/images/element/element-30.png" alt="element">
    </div>
    <div class="choose-element-four">
        <img src="<?= URL ?>/assets/theme/assets/images/element/element-31.png" alt="element">
    </div>
    <div class="choose-element-five">
        <img src="<?= URL ?>/assets/theme/assets/images/element/element-32.png" alt="element">
    </div>
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="choose-tab">
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade" id="software" role="tabpanel" aria-labelledby="software-tab">
                        <div class="choose-item">
                            <div class="choose-thumb">
                                <img src="<?= URL ?>/assets/theme/assets/images/element/element-27.png" alt="element">
                            </div>
                    ...
                    <div class="tab-pane fade show active" id="company" role="tabpanel" aria-labelledby="company-tab">
                        <div class="choose-item">
                            <div class="choose-thumb">
                                <img src="<?= URL ?>/assets/theme/assets/images/element/element-77.png" alt="element">
                            </div>
                            <div class="choose-content">
                    ...
                    <div class="tab-pane fade" id="client" role="tabpanel" aria-labelledby="client-tab">
                        <div class="choose-item">
                            <div class="choose-thumb">
                                <img src="<?= URL ?>/assets/theme/assets/images/element/element-78.png" alt="element">
                            </div>
                            <div class="choose-content">
...
<section class="call-to-action-section pb-120">
    <div class="call-to-action-element" data-aos="fade-left" data-aos-duration="1200">
        <img src="<?= URL ?>/assets/theme/assets/images/element/element-33.png" alt="element">
    </div>
...
<section class="service-section ptb-120">
    ...
    <div class="service-element-five">
        <img src="<?= URL ?>/assets/theme/assets/images/element/element-37.png" alt="element">
    </div>
...
<section class="about-section pt-120">
    ...
    <div class="about-element-four">
        <img src="<?= URL ?>/assets/theme/assets/images/element/element-41.png" alt="element">
    </div>
    <div class="about-element-five">
        <img src="<?= URL ?>/assets/theme/assets/images/element/element-42.png" alt="element">
    </div>
    <div class="container">
            ...
            <div class="row justify-content-center align-items-center mb-30-none">
                <div class="col-xl-6 col-lg-6 mb-30">
                    ...
                    <div class="about-thumb">
                        <img src="<?= URL ?>/assets/theme/assets/images/element/element-38.png" alt="element">
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 mb-30">
...
<section class="team-section ptb-130">
    <div class="team-element">
        <img src="<?= URL ?>/assets/theme/assets/images/element/element-43.png" alt="element">
    </div>
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                    ...
                    <div class="team-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="team-item">
                                    <div class="team-thumb">
                                        <img src="<?= URL ?>/assets/theme/assets/images/team/team-1.png" alt="team">
                            ...
                            <div class="swiper-slide">
                                <div class="team-item">
                                    <div class="team-thumb">
                                        <img src="<?= URL ?>/assets/theme/assets/images/team/team-2.png" alt="team">
                                        <div class="team-social-area">
                                            <ul class="team-social">
                                                <li><a href="#0"><i class="fab fa-facebook-f"></i></a></li>
                                                <li><a href="#0"><i class="fab fa-twitter"></i></a></li>
                            ...
                            <div class="swiper-slide">
                                <div class="team-item">
                                    <div class="team-thumb">
                                        <img src="<?= URL ?>/assets/theme/assets/images/team/team-3.png" alt="team">
                                        <div class="team-social-area">
                                            <ul class="team-social">
                                                <li><a href="#0"><i class="fab fa-facebook-f"></i></a></li>
                                                <li><a href="#0"><i class="fab fa-twitter"></i></a></li>
...
<section class="client-section ptb-120">
    <div class="client-element-one">
        <img src="<?= URL ?>/assets/theme/assets/images/element/element-44.png" alt="element">
    </div>
                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="client-item">
                                        <div class="client-header">
                                            ...
                                            <div class="client-quote">
                                                <img src="<?= URL ?>/assets/theme/assets/images/client/quote.png" alt="quote">
                                            </div>
                                        </div>
                                        ...
                                        <div class="client-footer">
                                            <div class="client-footer-user-thumb">
                                                <img src="<?= URL ?>/assets/theme/assets/images/client/client-1.png" alt="client">
                                            </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="client-item">
                                        ...
                                        <div class="client-footer">
                                            <div class="client-footer-user-thumb">
                                                <img src="<?= URL ?>/assets/theme/assets/images/client/client-2.png" alt="client">
                                            </div>
                                            <div class="client-footer-user-content">
                                ...
                                <div class="swiper-slide">
                                    <div class="client-item">
                                        ...
                                        <div class="client-footer">
                                            <div class="client-footer-user-thumb">
                                                <img src="<?= URL ?>/assets/theme/assets/images/client/client-3.png" alt="client">
                                            </div>
                                            <div class="client-footer-user-content">
...
<section class="subscribe-section ptb-120">
    <div class="subscribe-element-one">
        <img src="<?= URL ?>/assets/theme/assets/images/element/element-51.png" alt="element">
    </div>
    <div class="container">
        <div class="subscribe-area">
            <div class="subscribe-element-two">
                <img src="<?= URL ?>/assets/theme/assets/images/element/element-76.png" alt="element">
            </div>
            <div class="subscribe-element-three">
                <img src="<?= URL ?>/assets/theme/assets/images/element/element-50.png" alt="element">
            </div>
            <div class="row justify-content-center">
                <div class="col-xl-7 offset-xl-5">
                    <div class="subscribe-content">
                        ...
                        <form class="subscribe-form">
                            <label class="subscribe-icon"><img src="<?= URL ?>/assets/theme/assets/images/icon/icon-7.png" alt="icon"></label>
...
<footer class="footer-section pt-120">
    <div class="footer-element-one">
        <img src="<?= URL ?>/assets/theme/assets/images/element/element-48.png" alt="element">
    </div>
